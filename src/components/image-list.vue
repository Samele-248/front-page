    ...
    <div class="">
      <div>
        <div class="action-head">
          ...
          <el-button size="small" v-if="isShowAdd" @click="dialogUploadVisible=true" type="success">上传图片</el-button>
        </div>
        <el-row :gutter="20">
          <el-col v-for="(img, index) in image" @click.native="selected = index" :key="index" :xs="24" :sm="12" :md="8" :lg="6" :xl="3" class="image-item">
